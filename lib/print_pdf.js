...
export function openPrintWindow(quotation, result) {
  ...
  // Revoke the object URL after a safe delay (window keeps a copy once loaded)
    ...
    <div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Weight / Meter</td><td class="nm">${d.weight_per_meter_kg != null ? formatKg(d.weight_per_meter_kg) + '/m' : '&mdash;'}</td></tr>
        </tbody>
      </table>
    </div>
    <div>
